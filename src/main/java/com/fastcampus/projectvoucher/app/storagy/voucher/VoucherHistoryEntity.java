...
public class VoucherHistoryEntity extends BaseEntity {
    ...
    @Enumerated(EnumType.STRING) private RequesterType requesterType;
    private String requesterId;
    @Enumerated(EnumType.STRING) private VoucherStatusType status;
    ...
    public RequesterType requesterType() { return requesterType; }
